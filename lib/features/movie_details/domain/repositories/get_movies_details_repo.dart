...
abstract class GetMoviesDetailsRepo {
  Future<Either<RouteFailures, MovieDetailsModel>> getMoviesDetails(
      int movieId);

  Future<Either<RouteFailures, MovieScreenShotModel>> getMovieScreenShot(
      int movieId);

  Future<Either<RouteFailures, SimilarMoviesModel>> getSimilarMovie(
      int movieId);

  Future<Either<RouteFailures, MovieCastModel>> getMovieCast(int movieId);
}
